...
@section('content')
    <div
        class="min-h-screen grid grid-cols-1 place-items-center lg:grid-cols-2 lg:place-content-around lg:place-items-center p-6 bg-side-bar-color">
        <div class="hero">
            <div class="hero-content">
                <div class="text-white">
                    ...
                    <a href="{{ route('bookingGuest') }}">
                        <button
                            class=" text-side-bar-color bg-menu-hover hover:bg-[#d7d4ad] hover:text-white font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2">Booking
                            Now</button>
                    </a>
                </div>
            </div>
        </div>
        <div class="w-full sm:max-w-sm mt-6 px-6 py-4 rounded-lg bg-orange-100 shadow-md overflow-hidden sm:rounded-lg">
