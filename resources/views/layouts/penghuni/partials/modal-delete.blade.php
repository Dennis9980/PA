<section>
    <div id="delete-modal{{ $penghuni->id }}" tabindex="-1"
        ...
        <div class="relative p-4 w-full max-w-md max-h-full">
            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                <div class="p-4 md:p-5 text-center">
                    <svg class="mx-auto mb-4 text-orange-400 w-20 h-20 dark:text-orange-400" aria-hidden="true"
                    ...
                    <div class="flex flex-row justify-center">
                        ...
                        <button data-modal-hide="delete-modal{{ $penghuni->id }}" type="button"
