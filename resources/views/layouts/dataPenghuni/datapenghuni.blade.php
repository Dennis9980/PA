            ...
            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                ...
                <form class="p-4 md:p-5" action="{{ route('register') }}" method="POST">
                    ...
                    <div class="grid gap-4 mb-4 grid-cols-2">
                        ...
                        <div class="col-span-2 sm:col-span-1">
                            <label for="name"
                                class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">No Telepon (optional)</label>
...
<script>
    document.addEventListener("DOMContentLoaded", function() {
        ...
        const closeModalButton = document.querySelector('[data-modal-hide="crud-modal"]');
        const modal = document.querySelector('#crud-modal');

        openModalButton.addEventListener('click', function() {
            modal.classList.remove('hidden');
            modal.classList.add('block'); // Mengubah flex menjadi block jika itu lebih cocok
        });

        closeModalButton.addEventListener('click', function() {
            modal.classList.add('hidden');
            modal.classList.remove('block'); // Sesuai dengan penambahan di atas
        });
    });
</script>
