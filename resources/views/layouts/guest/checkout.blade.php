                    ...
                    <div class="text-black grid grid-cols-2 gap-10">
                        <div class="bg-white p-5 drop-shadow-xl rounded-xl">
                            ...
                            <button id="pay-button"
                                class="bg-blue-500 text-white font-bold py-3 px-6 mt-4 rounded hover:bg-blue-700">Bayar</button>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="px-24 text-black">
                <div class="drop-shadow-2xl bg-white rounded-xl p-4">
                    ...
                    <ul class="space-y-2 list-disc list-inside">
                        <li>Akses masuk ke rumah daun 24 jam menggunakan access card, namun tidak berlaku untuk teman.
                        </li>
                        <li>Batas waktu teman berkunjung hingga pukul 23.00 dan tidak boleh menginap. Hanya orang tua
                            dan saudara kandung yang diperbolehkan menginap.</li>
                        <li>Setelah pukul 23.00, teman tidak diperbolehkan masuk ke dalam kosan, meskipun hanya
                            sebentar. Teman dapat menunggu di luar gerbang.</li>
                        <li>Bapak Hari adalah penjaga malam virtual rumah daun. Aktivitas keluar masuk kosan setelah
                            pukul 23.00 akan termonitor.</li>
                        ...
                        <li>Pastikan pintu gerbang tertutup rapat sebelum pergi, terutama pada malam hari. Jangan
                            menarik paksa gerbang saat terbuka lebar, biarkan menutup sendiri secara otomatis.</li>
                        <li>Parkir motor di dalam rumah daun hanya untuk penghuni kos yang memiliki label dan motornya
                            tidak bocor oli. Parkirlah motor dengan rapi sesuai garis kuning di lantai. Motor teman
                            harap parkir di luar gerbang.</li>
