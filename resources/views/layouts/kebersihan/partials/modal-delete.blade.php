<section>
    <div id="delete-modal{{ $kebersihan->id }}" tabindex="-1"
            ...
            <div class="relative bg-white rounded-lg shadow  ">
                <div class="p-4 md:p-5 text-center">
                    ...
                    <div class="flex flex-row justify-center">
                        ...
                        <form action="{{ route('deleteDana', $kebersihan->id) }}" method="POST">
                            @csrf
                            @method('DELETE')
                            <button type="submit"
                        ...
                        <button data-modal-hide="delete-modal{{ $kebersihan->id }}" type="button"
