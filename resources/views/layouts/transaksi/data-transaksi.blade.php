<x-app-layout>
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
        <div class="pt-2 relative mx-auto text-gray-600 flex flex-row-reverse">
            <form action="{{ route('dataTransaksi') }}" method="GET">
                        ...
                        <tbody>
                            @if ($transaksi->count())
                                @foreach ($transaksi as $data)
                                    <tr class="bg-white border-b capitalize">
                                        <th scope="row"
                                        ...
                                        <td class="px-4 py-4 flex gap-3">
                                            <button class="m-1" data-modal-toggle="delete-modal{{ $data->id }}">
                            ...
                            @else
                                <tr>
                                    <td colspan="7" class="text-center py-4 font-bold text-lg">Data Kosong</td>
                                </tr>
                            @endif
                        </tbody>
                    </table>
